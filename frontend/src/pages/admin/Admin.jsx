...
export const MyMenu = () => {
  return (
    <Menu sx={{ backgroundColor: "#D9D9D9", color: "white", height: "100vh", overflowY: "auto" }}>
      <Menu.Item to="/admin/posts/create" primaryText="Crear Producto" leftIcon={<AddBoxRoundedIcon />} />
      <Menu.Item to="/admin/posts" primaryText="Listado de productos" leftIcon={<AutoAwesomeMotionRoundedIcon />} />
    </Menu>
  );
};

export const MyLayout = ({ children }) => <Layout menu={MyMenu}>{children}</Layout>;
...
export const AdminPage = () => {
  ...
  if (isMobile) {
    return (
      <div style={{ textAlign: "center", padding: "20px", color: "red", fontSize: "18px" }}>
        ❌ No puedes acceder al panel de administración desde un dispositivo móvil. Usa un ordenador.
      </div>
    );
  }
